  ...
  return (
    <div className="w-full h-full flex items-center justify-center gap-[6px] px-3">
      {Array.from({ length: 30 }).map((_, i) => (
        <span key={i} className="w-[3px] h-[3px] rounded-full bg-[#D5D0C8]" />
      ))}
    </div>
  );
}

export function ConversationBar({ state, barHeights, className, onConnect, onDisconnect, onToggleMute, onModelChange }: ConversationBarProps) {
  ...
  return (
    <div className={className}>
      <div className="relative rounded-[2rem] border border-white/85 bg-white/75 backdrop-blur-xl p-5 shadow-[0_16px_48px_rgba(120,110,95,0.08)]">
        ...
        <div className="relative z-50 flex items-center justify-between">
          <div className="h-12 w-[62%] rounded-2xl border border-[#EAE6DF] bg-[#FAFAF8] px-3 flex items-center justify-center overflow-hidden">
          ...
          <div className="ml-4 flex items-center gap-2">
            <button
              ...
              className="h-[34px] w-[34px] rounded-[10px] border border-[#DCD7CD] bg-[#FAF8F5] text-[#A8A296] hover:text-[#D9934E] disabled:opacity-50"
            ...
            <button
              ...
              className="h-[34px] w-[34px] rounded-[10px] border border-[#DCD7CD] bg-[#FAF8F5] text-[#A8A296] hover:text-[#D9934E]"
