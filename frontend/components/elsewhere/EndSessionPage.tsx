      ...
      <div className="relative flex h-screen flex-1 flex-col overflow-hidden bg-[#FAFAFA]">
        ...
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-5 pb-6 pt-20 md:px-8">
          <div className="flex w-full max-w-lg flex-col items-center">
            ...
            <motion.h2 initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.6 }} className="mb-4 text-center text-2xl font-semibold leading-[1.2] tracking-tight text-[#1C1C1E] md:text-3xl">What do you want Arche to be?</motion.h2>
            <motion.p initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.6 }} className="mb-8 max-w-md text-center text-sm leading-relaxed text-[#86868B] md:text-base">We&apos;re building Arche with the people who use it first. Tell us what you want Arche to do, what was missing, and how we can make it better.</motion.p>
